...
<div class="container-fluid">
        ...
        <main class="col-md-8 p-4 main-content order-md-1" style="width: 75%; margin-left: 400px;">
            <h1>Add category</h1>
            <form action="<?php echo BASE_URL_ADMIN . '?act=add_category' ?>" method="post" class="form">
                <div class="mb-3">
                <label for="" class="form-label">Add Size</label>
                <input type="text" class="form-control" id="exampleFormControlInput1" name="category_name" placeholder="">
                </div>
